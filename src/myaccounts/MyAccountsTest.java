...
public class MyAccountsTest extends Utility {
        ...
        //String baseUrl = "http://tutorialsninja.com/demo/index.php?route=account/register";
...
//        3.3 Enter First Name
            ...
            sendTextElement(By.id("input-firstname"), firstName);

//        3.4 Enter Last Name
            String lastName = "Hariharan";
            sendTextElement(By.id("input-lastname"), lastName);
//        3.5 Enter Email
            Random randomGenerator = new Random();
            int emailNum = randomGenerator.nextInt(9999);
            sendTextElement(By.id("input-email"), firstName + "." + lastName + emailNum + "@email.com");
...
//        3.6 Enter Telephone
            sendTextElement(By.id("input-telephone"), "7848548899");

//        3.7 Enter Password
            int passNum = randomGenerator.nextInt(999);
            sendTextElement(By.id("input-password"), lastName + "#" + passNum);
            String password = lastName + "#" + passNum;
            System.out.println("Password is " + lastName + "#" + passNum);

//        3.8 Enter Password Confirm
            sendTextElement(By.id("input-confirm"), lastName + "#" + passNum);
...
//        4.3 Enter Email address
            sendTextElement(By.id("input-email"), "Parmeshwaran.Hariharan5229@email.com");

//        4.4 Enter Last Name

//        4.5 Enter Password
            sendTextElement(By.id("input-password"), "Hariharan#239");
