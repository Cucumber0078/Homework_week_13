...
public class laptopsandnoteBooks1 extends Utility {
    ...
    public void verifyThatUserPlaceOrderSuccessfully() throws InterruptedException {
        ...
        sendTextElement(By.xpath("//tbody/tr[1]/td[4]/div[1]/input[1]"), "2");
        ...
        sendTextElement(By.xpath("//input[@id='input-payment-firstname']"), "Prime");
        sendTextElement(By.xpath("//input[@id='input-payment-lastname']"), "Testing");
        sendTextElement(By.xpath("//input[@id='input-payment-email']"), "ptesting123@gmail.com");
        sendTextElement(By.xpath("//input[@id='input-payment-telephone']"), "07123456911");
        sendTextElement(By.xpath("//input[@id='input-payment-address-1']"), "50 Brent Road");
        sendTextElement(By.xpath("//input[@id='input-payment-city']"), "London");
        sendTextElement(By.xpath("//input[@id='input-payment-postcode']"), "HA0 1AB");
        ...
        sendTextElement(By.xpath("//body/div[@id='checkout-checkout']/div[1]/div[1]/div[1]/div[3]/div[2]/div[1]/p[2]/textarea[1]"), "All good");
